...
// Faculty generates timetables for ALL departments and ALL 4 years at once.
export const SCOPES = [
  { value: 'faculty', label: 'Faculty (all depts + all years)' },
  { value: 'dept',    label: 'Department (all years)' },
  { value: 'batch',   label: 'Single Year Batch' },
]
