...
function Cell({ cell }) {
  ...
  const cls = isLab
    ? 'bg-[rgba(100,160,210,0.12)] border-[rgba(100,160,210,0.35)] hover:bg-[rgba(100,160,210,0.18)]'
    : published
    ? 'bg-ok/10 border-ok/30 hover:bg-ok/15'
    : 'bg-[rgba(66,158,189,0.12)] border-[rgba(66,158,189,0.35)] hover:bg-[rgba(66,158,189,0.18)]'

  const codeCls = isLab ? 'text-[#7ec8e3]' : published ? 'text-ok' : 'text-cyan-mid'
  ...
  return (
    <div className={`border rounded p-1.5 transition-colors ${cls}`}>
      <div className="flex items-baseline justify-between gap-1">
        ...
        {isLab && <span className="text-[8px] font-mono text-[#7ec8e3]/70">LAB</span>}
      </div>
      {cell.course_name && (
